<template>
    ...
    <div>
                ...
                <div class="container">
                    <div class="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                            ...
                            <h4 class="!text-white">{{jsonData[12]?.description}}</h4>
                        </div>
                        <div class="relative mt-6 md:mt-0" :data-aos="store.direction === 'rtl' ? 'fade-right' : 'fade-left'" data-aos-duration="1000">
                            ...
                            >
                                ...
                                <path
                                    ...
                                    fill="#47BDFF"
                                />
                                <path d="M145.965 174.047L133.395 184.489L129.167 180.795C134.998 179.172 140.632 176.909 145.965 174.047Z" fill="#47BDFF" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M101.087 226.817L104.894 194.033" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M94.564 205.316L96.2159 207.556" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M42.9938 204.758L24.74 175.502" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M39.0459 41.6523L49.0975 47.5601" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M90.7561 1L94.256 12.0301" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M154.699 15.5593L160.271 5.45312" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M197.757 56.0424L208.229 50.9746" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M6.9904 66.6797L5.81592 77.4578" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M11.7781 72.6706L1 71.4961" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke-linejoin="round"
                                />
                                <path d="M110.942 93.582H118.444" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                                <path
        ...
        <section class="relative overflow-hidden pt-14 lg:pb-48 lg:pt-[100px]">
            ...
            <img src="/assets/images/about-bg.png" alt="about-who-bg" class="-bottom-5 ltr:right-0 rtl:left-0 rtl:rotate-y-180 lg:absolute" />
        </section>
            ...
            <div class="container">
                ...
                <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-2">
                    <div class="group cursor-pointer text-center">
                        <div class="relative h-[500px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                        ...
                        <h6 class="text-sm font-bold">{{jsonData[0]?.role}}</h6>
                    </div>
        ...
        <section class="bg-gradient-to-b from-white/[55%] to-transparent py-14 dark:bg-none lg:py-[100px]">
            <div class="container">
                <div class="heading mb-10 text-center">
                    <h4>{{jsonData[17]?.description}}</h4>
                </div>
                <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="group mt-4 cursor-pointer text-center">
                        ...
                        <h6 class="text-sm font-bold">{{jsonData[3]?.role}}</h6>
                    </div>
                    <!-- <div class="group mt-4 cursor-pointer text-center">
                        <div class="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                        ...
                        <h6 class="text-sm font-bold">{{jsonData[4]?.role}}</h6>
                    </div>
                    <div class="group mt-4 cursor-pointer text-center">
                        <div class="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                        ...
                        <h6 class="text-sm font-bold">{{jsonData[5]?.role}}</h6>
                    </div> -->
                    <!-- <div class="group mt-4 cursor-pointer text-center">
                        <div class="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                        ...
                        <h6 class="text-sm font-bold">{{jsonData[6]?.role}}</h6>
                    </div>
                    <div class="group mt-4 cursor-pointer text-center">
                        <div class="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                        ...
                        <h6 class="text-sm font-bold">{{jsonData[7]?.role}}</h6>
                    </div> -->
                    <div class="group mt-4 cursor-pointer text-center">
                        <div class="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
                        ...
                        <h6 class="text-sm font-bold">{{jsonData[8]?.role}}</h6>
                    </div>
                    <div class="group mt-4 cursor-pointer text-center">
                        <div class="relative h-[280px] rounded-3xl transition-all duration-500 group-hover:shadow-[0_0_25px_#979797]">
